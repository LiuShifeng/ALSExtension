 ...
 */
private[recommendation] trait PMFParams extends SoRecModelParams with HasMaxIter with HasRegParam
 ...
 */
@Experimental
class PMF(override val uid: String) extends Estimator[SoRecModel] with SoRecParams {
